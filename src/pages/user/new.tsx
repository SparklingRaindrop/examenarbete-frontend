        ...
        <>
            ...
            <form onSubmit={handleOnSubmit}>
                <Input
                    ...
                    isError={{ isError: isError.email, error: '' }}
                ...
                <Input
                    ...
                    isError={{ isError: isError.username, error: '' }}
                    onChange={(event) => setUserInput(prev => ({
                        ...prev,
                ...
                <Input
                    ...
                    isError={{ isError: isError.password, error: '' }}
                    onChange={(event) => setUserInput(prev => ({
                        ...prev,
                ...
                <Input
                    ...
                    isError={{ isError: isError.confirmPassword, error: '' }}
                    onChange={(event) => setUserInput(prev => ({
                        ...prev,
